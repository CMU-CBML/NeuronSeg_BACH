...
%This function performs THB-spline refinement of a particular B-spline

%--Input Variable:
%indexi: B-spline index in u direction
%indexj: B-spline index in v direction
%level: Hierarchical level of the B-spline
%Dem: Basis data struct variable storing the B-spline basis function information
%Elem: Data struct variable storing the control grid element information
%P: THB-spline control points
%knotvectorU: knot vector in u direction
%knotvectorV: knot vector in v direction
%pU: B-spline degree in u direction
%pV: B-spline degree in v direction

%--Output Variable:
%Ifinal: Basis data struct variable storing the B-spline basis function
%information after refinement
%Efinal: Data struct variable storing the control grid element information
%after refinement
%Pfinal: THB-spline control points after refinement
