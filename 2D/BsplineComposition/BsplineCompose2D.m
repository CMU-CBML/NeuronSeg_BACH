function [ Vx_new_final, Vy_new_final ] = BsplineCompose2D( Vx, Vy, coef_x, coef_y, nx, ny)
...
%--Input Variable: 
%        Vx, Vy = transformation field from previous iteration
%        coef_x, coef_y = update transformation field
%        nx, ny = image size

%--Output Variable: 
%Vx_new_final, Vy_new_final = composed transformation field
