...
% 
%     Bvectf = compute_Integ_Domainf_reg(Jm,BIGMUXf, BIGMUYf, BIGMUZf, BIGMVXf, BIGMVYf, BIGMVZf, BIGMWXf, BIGMWYf, BIGMWZf, Bvectf,PHIU1, PHIV1, PHIW1,param.lambda_1,param.lambda_2,param.lambda_3,Wu,Wv,Ww,H);
%     
...
%     tic
    ...
    [pxxf,pyyf,pzzf] = tripleIterLoop(sizeImage, Pixel, Jm, ACCf);
    ...
    vtkwrite(str, 'structured_grid',X_vtk,Y_vtk,Z_vtk,'scalars','Intensity',M);
    
    
    subplot(2,2,1)
    imagesc(F_orig(:,:,floor(nz/2))-M(:,:,floor(nz/2)))
    colormap gray
