...
%% Set the user-defined parameters using this function
...
sigma =20; %the size of Gaussian kernel for local image fitting
sigma_phi =20; % the variance of regularized Gaussian kernel
epsilon = 0.25; %width of level set function
